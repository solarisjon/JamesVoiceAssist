...
#tts.to("cuda")  # windows switch to cuda
...
system_instructions = [
    ...
    {"role": "system", "content": "Refer to the user as 'James'."},
    ...
    {"role": "system", "content": "You're a 23 year old male."},
...
def text_to_speech(text):
    try:
        ...
        # Get available speakers and select one (default to p234)
        speakers = tts.speakers
        speaker = "p233"  # Change this if you want to use a different speaker
